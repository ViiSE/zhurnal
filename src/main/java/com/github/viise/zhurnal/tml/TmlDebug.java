...
public final class TmlDebug implements Template {
    ...
    public TmlDebug(List<Template> tmls) {
        this(TmlDebug.class, false, new TmlDateTime(), tmls);
    }

    /* Ctor 7 */
    public TmlDebug(Template tmlDateTime, List<Template> tmls) {
        this(TmlDebug.class, false, tmlDateTime, tmls);
    }
    ...
    public TmlDebug(Template... tmls) {
        this(TmlDebug.class, new TmlDateTime(), Arrays.asList(tmls));
    }
    ...
    public TmlDebug(String msg) {
        this(TmlDebug.class, new TmlDateTime(), msg);
    }
    ...
    public TmlDebug(String msg, List<Object> params) {
        this(TmlDebug.class, new TmlDateTime(), new Template[] { new TmlMsg(msg, params) });
    }
    ...
    public String create() {
        return new TmlEntry(lgClass, useFullName, new TmlTypeDebug(), tmlDateTime, tmls).create();
    }
}
