...
public final class TmlTrace implements Template {
    ...
    public TmlTrace(List<Template> tmls) {
        this(TmlTrace.class, false, new TmlDateTime(), tmls);
    }

    /* Ctor 7 */
    public TmlTrace(Template tmlDateTime, List<Template> tmls) {
        this(TmlTrace.class, false, tmlDateTime, tmls);
    }
    ...
    public TmlTrace(Template... tmls) {
        this(TmlTrace.class, new TmlDateTime(), Arrays.asList(tmls));
    }
    ...
    public TmlTrace(String msg) {
        this(TmlTrace.class, new TmlDateTime(), msg);
    }
    ...
    public TmlTrace(String msg, List<Object> params) {
        this(TmlTrace.class, new TmlDateTime(), new Template[] { new TmlMsg(msg, params) });
    }
    ...
    public String create() {
        return new TmlEntry(lgClass, useFullName, new TmlTypeTrace(), tmlDateTime, tmls).create();
    }
}
