...
public final class TmlTrace implements TemplateLeveled {
    ...
    /**
     * Creating trace template.
     * Examples:
     * <pre> {@code
     * String tml1 = new TmlTrace("Hello, {}!", "log").create();
     * // This code creating template:
     * // [LEVEL TRACE] [TIMESTAMP 2022-03-31T02:09:59.441] [CLASS org.viise.zhurnal.tml.TmlEntry] [MESSAGE Hello, log!]
     *
     * String tml2 = new TmlTrace(new Template[] { new TmlMsg("Hello, log!") }).create();
     * String tml3 = new TmlTrace("Hello, log!");
     * } </pre>
     *
