...
public class LgWarnTest {

    @Test
    public void print() {
        String actual = new LgWarn(
                LgWarnTest.class,
                new Template[] {
        ...
        assertTrue(
                actual.matches(
                "\\[WARN] \\[.*] \\[LgWarnTest] \\[HTTP <METHOD:GET> <ENDPOINT:/log/1> <STATUS:200 OK>] \\[DURATION <VALUE:300> <UNIT:MILLISECONDS>]"
                )
        );
    }
    ...
    public void print_ctor_1() {
        ...
        assertTrue(actual.matches("\\[WARN] \\[.*] \\[LgWarn] \\[MESSAGE Hello, log!]"));
    }
    ...
    public void print_ctor_1_fullName() {
        ...
        assertTrue(actual.matches("\\[WARN] \\[.*] \\[com\\.github\\.viise\\.zhurnal\\.lg\\.LgWarn] \\[MESSAGE Hello, log!]"));
    }
    ...
    public void print_ctor_15() {
        String actual = new LgWarn("Hello, log!").print();
        assertTrue(actual.matches("\\[WARN] \\[.*] \\[LgWarn] \\[MESSAGE Hello, log!]"));
    }
