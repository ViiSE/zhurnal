...
public class TmlEntryTest {
    ...
    public void create_ctor_1_fullName() {
        ...
        assertTrue(
                actual.matches(
                        "\\[LEVEL INFO] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlEntry] \\[MESSAGE Hello, log!]"
                )
        );
    }
    ...
    public void create_ctor_18() {
        ...
        assertTrue(
                actual.matches("\\[LEVEL INFO] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlEntry] \\[MESSAGE Hello, log!]"
                )
        );
    }
