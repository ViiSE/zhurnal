...
public class TmlInfoTest {
    ...
    public void create() {
        ...
        assertTrue(
                actual.matches(
                "\\[LEVEL INFO] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlInfoTest] \\[HTTP <METHOD:GET> <ENDPOINT:/log/1> <STATUS:200 OK>] \\[DURATION <VALUE:300> <UNIT:MILLISECONDS>]"
                )
        );
    }
    ...
    public void create_ctor_1_fullName() {
        ...
        assertTrue(
                actual.matches(
                        "\\[LEVEL INFO] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlInfo] \\[MESSAGE Hello, log!]"
                )
        );
    }
