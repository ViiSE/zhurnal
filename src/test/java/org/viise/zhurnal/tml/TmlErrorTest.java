...
public class TmlErrorTest {
    ...
    public void create() {
        ...
        assertTrue(
                actual.matches(
                "\\[LEVEL ERROR] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlErrorTest] \\[HTTP <METHOD:GET> <ENDPOINT:/log/1> <STATUS:200 OK>] \\[DURATION <VALUE:300> <UNIT:MILLISECONDS>]"
                )
        );
    }
    ...
    public void create_ctor_1_fullName() {
        ...
        assertTrue(
                actual.matches(
                        "\\[LEVEL ERROR] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlError] \\[MESSAGE Hello, log!]"
                )
        );
    }
