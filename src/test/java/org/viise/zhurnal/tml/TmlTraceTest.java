...
public class TmlTraceTest {
    ...
    public void create() {
        ...
        assertTrue(
                actual.matches(
                "\\[LEVEL TRACE] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlTraceTest] \\[HTTP <METHOD:GET> <ENDPOINT:/log/1> <STATUS:200 OK>] \\[DURATION <VALUE:300> <UNIT:MILLISECONDS>]"
                )
        );
    }
    ...
    public void create_ctor_1_fullName() {
        ...
        assertTrue(
                actual.matches(
                        "\\[LEVEL TRACE] \\[TIMESTAMP .*] \\[CLASS org\\.viise\\.zhurnal\\.tml\\.TmlTrace] \\[MESSAGE Hello, log!]"
                )
        );
    }
